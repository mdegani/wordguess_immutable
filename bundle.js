...
/***/ function(module, exports, __webpack_require__) {
	...
	var wordGuess = function wordGuess() {
	  ...
	  switch (action.type) {
	    case 'GUESS_LETTER':
	      ...
	      return state;
	    case 'CLEAR_GAME':
	      var newWord = window.prompt('New word (letters and spaces only):');
	      return state.merge({
	        guessedLetters: new _immutable.Set(),
	...
	var store = (0, _redux.createStore)(wordGuess);
	...
	WordGuess.propTypes = {
	  ...
	  correctGuesses: _react2.default.PropTypes.instanceOf(_immutable.Set),
	  guessesAllowed: _react2.default.PropTypes.number,
	  badGuesses: _react2.default.PropTypes.instanceOf(_immutable.Set),
	...
	var render = function render() {
	  ...
	  _reactDom2.default.render(_react2.default.createElement(WordGuess, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNativeComponentFromComposite = __webpack_require__(190);
...
/***/ function(module, exports, __webpack_require__) {
	...
	_assign(SyntheticEvent.prototype, {
	  ...
	  destructor: function () {
	    ...
	    if (process.env.NODE_ENV !== 'production') {
	      var noop = __webpack_require__(35);
