...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Users/markdegani/drafts/wordguess_immutable/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/Users/markdegani/drafts/wordguess_immutable/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var _gameReducer = __webpack_require__(181);

	var _gameReducer2 = _interopRequireDefault(_gameReducer);

	var _WordGuess = __webpack_require__(183);

	var _WordGuess2 = _interopRequireDefault(_WordGuess);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var render = function render() {
	  var lastState = store.getState();
	  _reactDom2.default.render(_react2.default.createElement(_WordGuess2.default, {
	    targetWord: lastState.get('targetWord'),
	    guesses: lastState.get('guessedLetters').toJS(),
	    correctGuesses: lastState.get('guessedLetters').intersect(lastState.get('targetWord')),
	    badGuesses: lastState.get('guessedLetters').subtract(lastState.get('targetWord')),
	    incorrectGuesses: lastState.get('guessedLetters').subtract(lastState.get('targetWord')).toJS() + '(' + lastState.get('guessedLetters').subtract(lastState.get('targetWord')).size + ')',
	    reveal: lastState.get('targetWord').map(function (t) {
	      return lastState.get('guessedLetters').has(t) || lastState.get('freeCharacters').has(t) ? t : '-';
	    }),
	    guessesRemaining: lastState.get('targetWord').reduce(function (acc, t) {
	      return lastState.get('guessedLetters').has(t) || lastState.get('freeCharacters').has(t) ? acc : acc + 1;
	    }, 0),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = new _immutable.Map({
	  guessedLetters: new _immutable.Set(),
	  targetWord: new _immutable.List('COMPUTER'.split('')),
	  guessesAllowed: 7,
	  gameEnded: false,
	  message: '',
	  alphabet: 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'.split(''),
	  allowedCharacters: new _immutable.Set('ABCDEFGHIJKLMNOPQRSTUVWXYZ '.split('')),
	  rainbow: new _immutable.List(['red', 'orange', 'yellow', 'green', 'blue', 'purple']),
	  freeCharacters: new _immutable.Set([' ']),
	  proposedWord: '',
	  showNewGameModal: false
	});

	var wordGuess = function wordGuess() {
	  ...
	  switch (action.type) {
	    ...
	    case 'NEW_GAME_FROM_MODAL':
	      var newWord = action.payload.newTargetWord;
	      return state.merge({
	        guessedLetters: new _immutable.Set(),
	        targetWord: new _immutable.List(newWord.toUpperCase().split('')).filter(function (nw) {
	          return state.get('allowedCharacters').has(nw);
	        }),
	        gameEnded: false,
	        message: '',
	    ...
	    case 'COLOR_SHIFT':
	      return state.merge({
	        rainbow: state.get('rainbow').unshift(state.get('rainbow').last()).setSize(state.get('rainbow').size)
	      });
	    case 'CHANGE_PROPOSED_WORD':
	      console.log('change!');
	      return state.set('proposedWord', action.payload.targetWord);
	    default:
	      return state;
	  }
	};

	exports.default = wordGuess;

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/markdegani/drafts/wordguess_immutable/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "gameReducer.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rainbowId = function rainbowId(num) {
	  return num % 6;
	};

	var WordGuess = function (_Component) {
	  _inherits(WordGuess, _Component);

	  function WordGuess() {
	    _classCallCheck(this, WordGuess);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(WordGuess).apply(this, arguments));
	  }
	  ...
	  _createClass(WordGuess, [{
	    ...
	    value: function render() {
	      ...
	      var targetWord = _props.targetWord;
	      var correctGuesses = _props.correctGuesses;
	      var guessesAllowed = _props.guessesAllowed;
	      var badGuesses = _props.badGuesses;
	      var reveal = _props.reveal;
	      var guessesRemaining = _props.guessesRemaining;
	      var alphabet = _props.alphabet;
	      var rainbow = _props.rainbow;
	      var store = _props.store;
	      var newGameModalIsVisible = _props.newGameModalIsVisible;
	      var proposedWord = _props.proposedWord;

	      var loss = badGuesses.size >= guessesAllowed ? true : false;
	      var win = guessesRemaining === 0;
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          win ? _react2.default.createElement(
	            ...
	            reveal.map(function (r, i) {
	              return _react2.default.createElement(
	                'span',
	                { key: i, className: rainbow.get(rainbowId(i)), onClick: function onClick() {
	                    store.dispatch({
	                      type: 'COLOR_SHIFT'
	                    });
	                  } },
	        ...
	        loss ? _react2.default.createElement(
	          'div',
	          null,
	        ...
	        loss || win ? null : _react2.default.createElement(
	          'div',
	          {
	            className: 'flex' },
	          _react2.default.createElement(
	            ...
	            alphabet.map(function (l, i) {
	              return _react2.default.createElement(
	                'button',
	                {
	                  className: badGuesses.has(l) ? 'flex-item bg-red' : correctGuesses.has(l) ? 'flex-item bg-lime' : 'flex-item',
	                  key: i,
	                  onClick: function onClick() {
	                    store.dispatch({
	                      type: 'GUESS_LETTER',
	...
	WordGuess.propTypes = {
	  targetWord: _react2.default.PropTypes.instanceOf(_immutable.List),
	  correctGuesses: _react2.default.PropTypes.instanceOf(Set),
	  guessesAllowed: _react2.default.PropTypes.number,
	  badGuesses: _react2.default.PropTypes.instanceOf(Set),
	  reveal: _react2.default.PropTypes.instanceOf(_immutable.List),
	  guessesRemaining: _react2.default.PropTypes.number,
	  alphabet: _react2.default.PropTypes.array,
	  rainbow: _react2.default.PropTypes.instanceOf(_immutable.List),
	  newGameModalIsVisible: _react2.default.PropTypes.bool,
	  proposedWord: _react2.default.PropTypes.string,
	  store: _react2.default.PropTypes.object
	};

	exports.default = WordGuess;

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/markdegani/drafts/wordguess_immutable/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "WordGuess.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/* Basscss Btn Sizes */\n\n.btn-small {\n  padding: .25rem .5rem;\n}\n\n.btn-big {\n  padding: 1rem 1.25rem;\n}\n\n.btn-narrow {\n  padding-left: .5rem;\n  padding-right: .5rem;\n}\n\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/* Basscss Colors */\n\n/* \n\n   VARIABLES\n\n   - Cool\n   - Warm\n   - Gray Scale\n\n*/\n\n.black  { color: #111111 }\n\n.gray   { color: #AAAAAA }\n\n.silver { color: #DDDDDD }\n\n.white  { color: #FFFFFF }\n\n.aqua  { color: #7FDBFF }\n\n.blue  { color: #0074D9 }\n\n.navy  { color: #001F3F }\n\n.teal  { color: #39CCCC }\n\n.green { color: #2ECC40 }\n\n.olive { color: #3D9970 }\n\n.lime  { color: #01FF70 }\n\n.yellow  { color: #FFDC00 }\n\n.orange  { color: #FF851B }\n\n.red     { color: #FF4136 }\n\n.fuchsia { color: #F012BE }\n\n.purple  { color: #B10DC9 }\n\n.maroon  { color: #85144B }\n\n.color-inherit { color: inherit }\n\n.muted { opacity: .5 }\n\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/* Basscss Progress */\n\n.progress {\n  display: block;\n  width: 100%;\n  height: 0.5625rem;\n  margin: .5rem 0;\n  overflow: hidden;\n  background-color: rgba(0, 0, 0, .125);\n  border: 0;\n  border-radius: 10000px;\n  -webkit-appearance: none;\n}\n\n.progress::-webkit-progress-bar {\n  -webkit-appearance: none;\n  background-color: rgba(0, 0, 0, .125)\n}\n\n.progress::-webkit-progress-value {\n  -webkit-appearance: none;\n  background-color: currentcolor;\n}\n\n.progress::-moz-progress-bar {\n  background-color: currentcolor;\n}\n\n", ""]);
